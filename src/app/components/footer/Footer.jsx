      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 ">
        <div className="mx-auto max-w-md">
          ...
          <form className="mt-6" onSubmit={handleSubscribe}>
            <div className="relative max-w-lg flex justify-between items-center gap-2">
              ...
              <button className="bg-blue-500 text-white rounded-full bg-green-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700">
                Subscribe
              </button>
          ...
          {subscribed && (
            <div className="mt-2 text-green-600">
              Thank you for subscribing! You will receive the latest news in your email.
            </div>
          )}
        </div>
